...
@interface HalsRootViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end


@implementation HalsRootViewController
...
- (void)viewDidLoad {
	...
	self.navigationItem.title = @"Hal's test"; 
...
- (void)insertNewObject {
	...
	newObservation.species = [Species findOrCreateSpeciesWithCommonName:@"Striped Skunk"
															  latinName:@"Mephitis mephitis"
																nidCode:@"624"
														speciesCategory:[SpeciesCategory findOrCreateSpeciesCategoryWithName:@"Mammal (Medium)" 
																												 codeInteger:4 
																												   inContext:context]
															  inContext:context];
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    */
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"observationTimestamp" ascending:NO];

...
@synthesize testObservation = testObservation_;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch (indexPath.row) 
	{
		...
		case 0:
			cell.textLabel.text = @"Hal's test examples";
			break;
		case 1:
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch (indexPath.row) 
	{
		case 0: 
		{
			nextViewController = [[HalsRootViewController alloc] initWithStyle:UITableViewStylePlain];
		}
			break;
...
- (void)dealloc 
{
	[testObservation_ release], testObservation_ = nil;
